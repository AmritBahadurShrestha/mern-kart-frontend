...
const ConfirmationModal: React.FC<IProps> = ({ onCancel, onConfirm }) => {
  return (
    <div
      onClick={onCancel}
    ...
    >
      ...
      >
        ...
        <div className="mt-8 flex justify-center gap-4">
          ...
          <button
            onClick={onConfirm}
            className="cursor-pointer px-6 py-2.5 rounded-lg bg-red-600 text-white text-sm font-medium shadow-md hover:bg-red-700 focus:ring-2 focus:ring-red-400 transition-colors transform hover:scale-105 active:scale-95"
          >
            Delete
          </button>
        </div>
